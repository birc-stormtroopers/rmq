...
and we could go with any $k>1$. The factor of two difference, of course, is the conversion factor between base-two and base-four logarithms. I went with the base-two because we usually work with base-two logarithms in computer science, and in particular when we think about numbers and bits and such. Whatever floats your boat, though, the difference when changing bases is just a constant, and for base-four to base-two it is $\log_4 x = \log_2 x / \log_2 4 = \log_2 / 2$.
